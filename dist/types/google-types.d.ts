// The below is sourced from this repo/file:
//   https://github.com/googleapis/google-api-nodejs-client/blob/main/src/apis/sheets/v4.ts
// To create the below I did a find replace:
//   Find: /export interface Schema\$(.*?) \{/g
//   Repl: /export type $1 = {/
// Then again:
//   Find: /Schema\$/g
//   Replace: // (empty string)
// After that, you'll have errors starting around line 4800.
// The types with these errors seem specific to the API interface.
// I only wanted types specific to the returned sheets object.
// So I copied the types up to the first error and pasted below
